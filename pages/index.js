...
const KonvaCanvas = () => {
  ...
  const [toys] = useState([
    ...
    "/images/character/image2.png",
    "/images/character/image3.png",
    "/images/character/image4.png",
    "/images/character/image5.png",
  ]);
  ...
  const handleBackgroundClick = (e) => {
    ...
    const x = isTouch
      ? evt.changedTouches[0].clientX - containerRect.left
      : evt.layerX;
    const y = isTouch
      ? evt.changedTouches[0].clientY - containerRect.top
      : evt.layerY;
      ...
      if (stickerImage) {
        ...
        const newStickers = stickers.map((sticker, index) => {
          if (index === selectedStickerIndex) {
            return {
              ...sticker,
              positions: [...sticker.positions, { x: newX, y: newY }],
            };
          }
          return sticker;
        });
